  ...
  const fetchStats = async () => {
    try {
      ...
      const revenue = loads
        ...
        .reduce((acc: number, l: any) => acc + (l.price || 0), 0);

      setStats({
        totalUsers: driversSnap.size + companiesSnap.size,
    ...
    try {
      ...
      setDrivers(
        snap.docs.map((d: any) => ({
          ...
          truck_number: d.data().truckNumber || "N/A",
          truck_type: d.data().truckType || "N/A",
          city: d.data().city || "N/A",
